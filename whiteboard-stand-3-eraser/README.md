...
and eraser pads stack in open-front boxes. No carry handle — both walls are
plain.

<img src="images/whiteboard-caddy.png" alt="Whiteboard caddy" width="620">

This is a variant of the [original whiteboard caddy](../whiteboard-stand/)
with a third eraser bay added and the carry handle removed. As configured it
holds **8 lap boards** (9"×12"), **10 markers** and **24 eraser pads** in
**3 boxes**. Prints in one piece, flat on its base, with no supports.

| | |
|---|---|
| Size | 244 × 159 × 94 mm |
| Print time | 7–12 h, depending on printer and settings |
| Material | ~350 g PETG (more with the third eraser box) |
| Supports | None |
